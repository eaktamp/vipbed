...
/*
$sql = " SELECT w.ward,w.name as wardname,COUNT(*) as total
FROM bedno as b
...
$sqls = " SELECT COUNT(*) as sum_total
FROM bedno as b
INNER JOIN roomno AS r ON b.roomno = r.roomno
INNER JOIN ward AS w ON w.ward = r.ward
INNER JOIN roomtype AS t ON t.roomtype = r.roomtype
        ...
        <nav id="sidebar" class="">
            ...
            <div class="nalika-profile">
                <div class="profile-dtl">
                    ...
                    <h2>นายทดสอบ <span class="min-dtn">ระบบ</span></h2>
                </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
                                            <div class="breadcomb-icon">
                                                <i class="icon nalika-user css-ward"></i>
                                            </div>
                                            <div class="breadcomb-ctn css-ward" onclick="window.location.href='index.php'">
                                                <h2>จำนวนห้องพิเศษทั้งหมด <?php echo $sum_total; ?> ห้อง</h2>
                                                <p>จองห้องพิเศษ <span class="bread-ntd"> </span></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="<?php// echo $row_result['bedno'];; ?>"><?php// echo $row_result['bedno']; ?></h4>
                    </div>
                    <div class="modal-body">
                        ...
                        input status
                        <?php
                        //           $sql_bed = " SELECT hn FROM ovst WHERE 1 = 1 limit 1  ";
                        // $query_bed = pg_query($conn, $sql_bed);
                        // $row_result = pg_fetch_array($query_bed);
                        // echo $sql_bed;
                        // echo $row_result['hn'];
            ...
            <div class="row admin text-center">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        while ($row_result = pg_fetch_array($query)) {


                        ?>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 css-ward " style="margin-bottom: 10px;" data-toggle="modal" data-target="#<?php echo $row_result['ward']; ?>">
                                <!-- <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 css-ward " style="margin-bottom: 10px;" onclick="window.location.href='bed_detail.php?ward=<?php echo $row_result['ward']; ?>&wardname=<?php echo $row_result['wardname']; ?>&bedsum=<?php echo $row_result['total']; ?>'"> -->
                                <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                    <h4 class="text-left text-uppercase css-ward"><b><?php echo $row_result['wardname']; ?></b></h4>
                                    <div class="row vertical-center-box vertical-center-box-tablet">
                                        <div class="col-xs-3 mar-bot-15 text-left">
                                            <label class="label bg-green"><?php echo $row_result['total'] / 100; ?> %<i class="fa fa-level-up" aria-hidden="true"></i></label>
                                        </div>
                                        <div class="col-xs-9 cus-gh-hd-pro">
                                            <h2 class="text-right no-margin"><?php echo $row_result['total']; ?></h2>
                                        </div>
                                    </div>
                                    <div class="progress progress-mini">
                                        <div style="width: <?php echo $row_result['total']; ?>%;" class="progress-bar bg-green"></div>
                                    </div>
                                </div>
                            </div>

                            <div class="modal fade" id="<?php echo $row_result['ward']; ?>" role="dialog">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title">จองห้องพิเศษ : <?php echo $row_result['wardname']; ?></h4>
                                        </div>
                                        <div class="modal-body">
                                            <p><?php echo $bedno; ?></p>
