...
$sql = " SELECT *,n.icode,n.name AS ward_vip
FROM bedno as b
...
<body>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="breadcome-list">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 css-ward" onclick="window.location.href='index.php'">
                                        <div class="breadcomb-wp">
                                            <div class="breadcomb-icon">
                                                <i class="icon nalika-home"></i>
                                            </div>
                                            <div class="breadcomb-ctn">
                                                <h2><?php echo $wardname;?></h2>
                                                <p>ห้องพิเศษ โรงพยาบาลเจ้าพระยาอภัยภูเบศร <span class="bread-ntd">...</span></p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        while ($row_result = pg_fetch_array($query)) {
                                    $bedno = $row_result['bedno'];
                                    $an = $row_result['an'];
                                    $hn = $row_result['hn']; 
                                    $ward_vip = $row_result['ward_vip']; 

                        ?>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 css-ward " style="margin-bottom: 10px;"  data-toggle="modal" data-target="#<?php echo $bedno; ?>"  data-id="">
                            
                            <!-- <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 css-ward " style="margin-bottom: 10px;" >  -->
                                <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                    <h4 class="text-left text-uppercase css-ward"><b><?php echo $row_result['bedno']; ?></b>&nbsp;&nbsp;<span class="css_vip"><?php echo $ward_vip;?></span></h4>
                                    <div class="row vertical-center-box vertical-center-box-tablet">
                                        <div class="col-xs-3 mar-bot-15 text-left">
                                            <label class="label bg-green"><?php echo $an; ?> <i class="fa fa-level-up" aria-hidden="true"></i></label>
                                        </div>
                                        <div class="col-xs-9 cus-gh-hd-pro">
                                            <h2 class="text-right no-margin"><?php echo $hn; ?></h2>
                                        </div>
                                    </div>
                                    <div class="progress progress-mini">
                                        <div style="width: <?php //echo $bedsum; ?>%;" class="progress-bar bg-green"></div>
                                    </div>
                                </div>
                            </div>
 ...
 <!-- Modal -->
  ...
  <div class="modal fade" id="<?php echo $bedno; ?>" role="dialog">
